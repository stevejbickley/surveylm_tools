...
# Function to generate pairwise combinations of baseline scenarios and treatment variations, and assign unique IDs
def generate_flexible_combinations_with_ids_to_excel(baseline_scenarios_start, baseline_scenarios_end, treatment_variations, baseline_prefixes, treatment_prefixes, answer_instruction, output_filename, treatment_to_baseline_map=None, joining_text=', who '):
    """
    Generate all combinations of baseline scenarios and treatment variations with unique IDs and save them to an Excel file.
    Args:
    - baseline_scenarios (list): List of baseline scenarios.
...
baseline_scenarios_end = [
    "Please indicate how many $USD (0-10) you offer to the Responder. The Responder will then make a decision whether to accept or reject this offer. If the Responder accepts your offer, they will get the units you offered to them, and you will keep the rest of the $10. If the Responder rejects your offer, both of you will get $0.",
...
baseline_prefixes = [
    ...
    "ultimatum_responder_10total_10to30pct",
    "ultimatum_responder_10total_40to60pct",
    "ultimatum_responder_10total_70to90pct",
    "ultimatum_responder_10total_100pct",
    "ultimatum_responder_10total_50pct",
    "ultimatum_responder_10total_60pct",
    "ultimatum_responder_10total_70pct",
    "ultimatum_responder_10total_80pct",
    "ultimatum_responder_10total_90pct",
    "ultimatum_responder_10total_100pct",
    "ultimatum_responder_100total_0pct",
    "ultimatum_responder_100total_10pct",
    "ultimatum_responder_100total_20pct",
    "ultimatum_responder_100total_30pct",
    "ultimatum_responder_100total_40pct",
    "ultimatum_responder_100total_50pct",
    "ultimatum_responder_100total_60pct",
    "ultimatum_responder_100total_70pct",
    "ultimatum_responder_100total_80pct",
    ...
    "ultimatum_responder_1000total_20pct",
    "ultimatum_responder_1000total_30pct",
    "ultimatum_responder_1000total_40pct",
    "ultimatum_responder_1000total_50pct",
    "ultimatum_responder_1000total_60pct",
    "ultimatum_responder_1000total_70pct",
    "ultimatum_responder_1000total_80pct",
    ...
    "ultimatum_responder_10000total_20pct",
    "ultimatum_responder_10000total_30pct",
    "ultimatum_responder_10000total_40pct",
    "ultimatum_responder_10000total_50pct",
    "ultimatum_responder_10000total_60pct",
    "ultimatum_responder_10000total_70pct",
    "ultimatum_responder_10000total_80pct",
...
# Generate combinations with IDs and save to Excel
generate_flexible_combinations_with_ids_to_excel(baseline_scenarios_start, baseline_scenarios_end, treatment_variations, baseline_prefixes, treatment_prefixes, answer_instruction, output_filename, treatment_to_baseline_map=None, joining_text=', who ')
